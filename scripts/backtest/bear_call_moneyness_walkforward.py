...
"""
Bear-call moneyness — walk-forward validation per ticker.
...
Output: data/profile/bear_call_moneyness_walkforward.parquet
"""
...
CYCLES = ROOT / "data/profile/bear_call_moneyness_results.parquet"
OUT = ROOT / "data/profile/bear_call_moneyness_walkforward.parquet"
...
def main():
    ...
    rec_out = ROOT / "data/profile/bear_call_moneyness_recommendation.parquet"
